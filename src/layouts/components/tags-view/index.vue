...
<template>
    <div class="tags-view-container">
        <ScrollPane class="tags-view-wrapper" :tag-refs="tagRefs">
            <router-link ref="tagRefs" v-for="tag in tagsViewStore.visitedViews" :key="tag.fullPath"
                :class="{ active: isActive(tag) }" class="tags-view-item" :to="{ path: tag.fullPath, query: tag.query }"
