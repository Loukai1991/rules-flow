...
import { getVisitedViews, setVisitedViews, getCachedViews, setCachedViews } from "@/util/cache/local-storage"

export type TagView = Partial<RouteLocationNormalized>

export const useTagsViewStore = defineStore("tags-view", () => {
  const cacheTagsView = true;
  ...
  const addVisitedView = (view: TagView) => {
    ...
    console.log('visited', visitedViews.value)
  }
